...
#include "clober_ortools/absl/base/internal/inline_variable.h"
#include "clober_ortools/absl/random/bernoulli_distribution.h"
#include "clober_ortools/absl/random/beta_distribution.h"
#include "clober_ortools/absl/random/exponential_distribution.h"
#include "clober_ortools/absl/random/gaussian_distribution.h"
#include "clober_ortools/absl/random/internal/distribution_caller.h"  // IWYU pragma: export
#include "clober_ortools/absl/random/internal/uniform_helper.h"  // IWYU pragma: export
#include "clober_ortools/absl/random/log_uniform_int_distribution.h"
#include "clober_ortools/absl/random/poisson_distribution.h"
#include "clober_ortools/absl/random/uniform_int_distribution.h"
#include "clober_ortools/absl/random/uniform_real_distribution.h"
#include "clober_ortools/absl/random/zipf_distribution.h"
...
RealType Beta(URBG&& urbg,  // NOLINT(runtime/references)
  ...
  static_assert(
      ...
      "clober_ortools/absl::Beta<RealType, URBG>(...)");
...
RealType Exponential(URBG&& urbg,  // NOLINT(runtime/references)
  ...
  static_assert(
      std::is_floating_point<RealType>::value,
      "Template-argument 'RealType' must be a floating-point type, in "
      "clober_ortools/absl::Exponential<RealType, URBG>(...)");
...
RealType Gaussian(URBG&& urbg,  // NOLINT(runtime/references)
  ...
  static_assert(
      std::is_floating_point<RealType>::value,
      "Template-argument 'RealType' must be a floating-point type, in "
      "clober_ortools/absl::Gaussian<RealType, URBG>(...)");
...
IntType LogUniform(URBG&& urbg,  // NOLINT(runtime/references)
  ...
  static_assert(std::is_integral<IntType>::value,
                ...
                "clober_ortools/absl::LogUniform<IntType, URBG>(...)");
...
IntType Poisson(URBG&& urbg,  // NOLINT(runtime/references)
  ...
  static_assert(std::is_integral<IntType>::value,
                "Template-argument 'IntType' must be an integral type, in "
                "clober_ortools/absl::Poisson<IntType, URBG>(...)");
...
IntType Zipf(URBG&& urbg,  // NOLINT(runtime/references)
  ...
  static_assert(std::is_integral<IntType>::value,
                "Template-argument 'IntType' must be an integral type, in "
                "clober_ortools/absl::Zipf<IntType, URBG>(...)");
